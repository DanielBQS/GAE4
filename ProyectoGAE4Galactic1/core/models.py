...
class Rol(models.Model):
    ...
    nombre_rol = models.CharField(max_length=20, choices=ROL_CHOICES, verbose_name='Rol')
...
class Venta(models.Model):
    ...
    id_cliente = models.CharField(max_length=20, verbose_name='ID de cliente')
...
class DetalleVenta(models.Model):
    ...
    id_venta = models.ForeignKey(Venta, on_delete=models.CASCADE, verbose_name='ID de venta')
    id_Eproducto = models.ForeignKey(Producto, on_delete=models.CASCADE, verbose_name='ID de producto')
